...
키가 없어도 앱은 뜹니다. **예문 66개**(낱말 36 · 문장 30)가 칩으로 올라와 있어 사진 없이
...
예문 66개면 글자 항목이 300개를 넘어 손으로는 검증이 안 됩니다.
...
초성 하나만 남깁니다 — `كتب` 는 「ㅋ ㅌ 브」로 나옵니다.
...
src/
  ...
  components/
    ...
    Controls.jsx         재생/멈춤·이전/다음·속도·발음 단위·소리·듣기
...
**소리** 스위치를 끄면 재생 중에는 아무것도 읽지 않고, 🔊 듣기 버튼만 동작합니다.
