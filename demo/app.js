...
/*__TRANSLITERATE__*/
  ...
  /* ═══ 낱말 다듬기 ═════════════════════════════════════════════════════════
     build.mjs 가 src/lib/polish.js 를 여기에 넣는다. 글자별 한글을 낱말
     수준으로 다듬는다 (비느트 → 빈트).
     ═══════════════════════════════════════════════════════════════════════ */
  var Polish = /*__POLISH__*/ {};

  /* ═══ 접사 떼기 ═══════════════════════════════════════════════════════════
     build.mjs 가 src/lib/affix.js 를 여기에 넣는다. 정관사·전치사·소유
     어미가 붙은 낱말(اَلْكِتَاب, كِتَابِي …)을 사전에서 찾을 자리로 되돌린다.
     ═══════════════════════════════════════════════════════════════════════ */
  var Affix = /*__AFFIX__*/ {};
